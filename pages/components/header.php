<header id="native-header">
        <nav aria-label="first_header" class="navbar navbar-dark bg-dark">
            <img id="company_name" src="../assets/img/logo.png" alt="InternQuest logo" width="300px">
            <div id="button_div_header">
                ...
                <img id="account_avatar" src="../assets/img/avatar.svg" alt="Avatar image" width="50px">
            </div>
        </nav>
